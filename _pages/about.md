...
In one project, we are looking at the role of flexion in the performance of fish's swimming. 
...
In the other project, we are looking at the sensory control strategy of fish. We are focusing on a scenario similar to predation of fish. A swimmer is moving in the wake left by an oscillating airfoil. It's goal is to locate the airfoil by measuring local flow property and swimming in the wake. We are interested in these questions. Firstly, what flow property is the most effective sensory cue, whether it is velocity, pressure or vorticity? Secondly, whether spatially distributed sensors array or measuring time series can enhance its perforamnce? Thirdly, what is the optimal sensory-control strategy in this task?  
