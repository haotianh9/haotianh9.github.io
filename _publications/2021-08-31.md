...
Furthermore, the linear relationship between `$T*_{LEV}$` and `$T**_{LEV}$` before reaching the formation number can suggest a potential model for predicting the circulation growth of LEV based on wing kinematics.

![flapping wing experiment](/files/flapping_wing.gif)

![flow field](/files/vortexloopillustration.png)

![vortex loop](/files/vortexloop.jpg)





[Download paper here](/files/publications/Xiang2021.pdf)
