...
\begin{document}
	...
	\begin{resume}%
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
		  \hspace{-4ex}{2023}
		   & \nhphantom{6. }6. \textbf{Hang, H.}, Heydari, S., Jiao, Y, \& Kanso, E. (in preparation). Parsimonious flow sensing strategies exploit traveling wave character to track hydrodynamic trails  \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
			...
			& \hspace{2ex} joint with \textit{Sina Heydari}, \textit{Yusheng Jiao}\\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
			\hspace{-4ex}{2016 - 2019} & {\bf  High lift generation mechanisms in insects flight}, supervised by \textit{Prof.~Hong Liu} \textit{Dr.~Yang Xiang} and \textit{Dr.~Suyang Qing}\\
