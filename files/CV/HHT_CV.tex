...
\usepackage{fontawesome6} % requires a recent TeX distribution
\newcommand{\pubnum}[1]{\makebox[0em][r]{#1.}\ } % adjust 2.4em to taste
...
\begin{document}
	...
	\begin{resume}%
		...
		\begin{longtable}{@{}>{\raggedright}p{0.5\linewidth}
				p{\dimexpr0.5\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
			{\bf Mobile:} (+86)18321333510; (+33) 0766087923 &  {\bf Website \& Social Media:}   \href{https://haotianh9.github.io/}{\faIcon{house}}  \hspace{1ex} \href{https://github.com/haotianh9}{\textit{\faGithub}}   \hspace{1ex}  \href{https://www.linkedin.com/in/haotian-hang-0a23471a3/}{\textit{\faLinkedin}} \hspace{1ex} \href{https://www.researchgate.net/profile/Haotian-Hang/}{\textit{\aiResearchGate}}  \hspace{1ex} \href{https://scholar.google.com/citations?user=3hzPBNoAAAAJ}{\textit{\aiGoogleScholar}}\\
			{\bf E-mail:} hanghaotian@gmail.com, haotian.HANG@univ-amu.fr
			&
            {\bf Address:} 49 Rue Frédéric Joliot Curie, 13013 Marseille, France
			\\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
			...
			& {~Doctor of Philosophy, Mechanical Engineering, May 2025 (USC Viterbi School of Engineering’s Best Dissertation Award) } \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
                \hspace{-4ex}{2026/3 -  } & {\bf Postdoctral researcher},  Institut de Recherche sur les Phénomènes Hors Equilibre (IRPHE), Aix-Marseille Université, France, PI: \textit{Prof.~Aurore Loisy}\\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
                ...
                % all published papers are in APA format in google scholar!!!
                  \hspace{-4ex}{On going}   & \pubnum{18} \textbf{Hang, H.}, Swanson, N.,  Peterson, A.,  McHenry, M., Bialek, W.  \& Kanso, E.$^*$ (in preparation) Statistical mechanics for Confined Fish Schools \\
                & \pubnum{17} Cheng, H., \textbf{Hang, H.}, Huang, C., Barnett, A., \& Kanso, E.$^*$ (in preparation) Collective transitions in bi-chamber domain \\
              &   \pubnum{16} Chan, A., Hayward, A., \textbf{Hang, H.}, Swanson, N., Guo, H. , Martinez, C., McHenry, M. \& Kanso, E.$^*$ (in preparation) The Physics of Schooling:  Correlation-Based Insights into Fish Collective Behavior \\
                  & \pubnum{15} \textbf{Hang, H.}, Huang, C., \& Kanso, E.$^*$ (in preparation) Chaotic Mixing in Large Schools of Fish \\
                 & \pubnum{14} Cheng, H., \textbf{Hang, H.}, Stone, H.,  \& Kanso, E.$^*$ (in preparation) Active Brownian Particles in Circular Confinement \\
                 & \pubnum{13} \textbf{Hang, H.},  \& Kanso, E.$^*$ (in preparation) Scale-Free Correlations in Emergent Rotational Order \\
                 \hspace{-4ex}{2026}        &  \pubnum{12} \textbf{Hang, H.}$^\#$, Shen, Y.$^\#$, Zhu, V.$^{*}$, Cruz, J, Li, M..  (submitted) \href{https://arxiv.org/abs/2511.00024}{\textit{Chitchat with AI: understand the supply chain carbon disclosure of companies worldwide through Large Language Model}}  \\
                  & \pubnum{11} Gebhardt, R., \textbf{Hang, H.}, Paley, D.$^*$, \& Kanso, E. (2026) \href{https://cdcl.umd.edu/papers/robosoft26.pdf}{\textit{Fluid-structure interaction dynamics and feedback control of multiple flexible bioinspired swimmers}} RoboSoft\\
                     & \pubnum{10} \textbf{Hang, H.}, Huang, C., Barnett, A., \& Kanso, E.$^*$ (accepted by Nature Communication) \href{https://arxiv.org/abs/2505.05822 }{\textit{Self-reorganization and Information Transfer in Massive Schools of Fish}} \\
                       & \pubnum{9}  \textbf{Hang, H.}, Jiao, Y., Merel, J., \& Kanso, E.$^*$ (2026). \href{https://doi.org/10.1103/qj9q-p7rg}{\textit{Flow Currents Support Simple and Versatile Trail-Tracking Strategies}}. Physical Review Research, 8(1), 013019.  \\
          \hspace{-4ex}{2025}    
                &        \pubnum{8} Linot, A. J.$^*$, \textbf{Hang, H.}, Kanso, E., \& Taira, K. (2025). \href{https://doi.org/10.1038/s42005-025-02417-2}{\textit{Hierarchical equivariant graph neural networks for forecasting collective motion in vortex clusters and microswimmers}} . Communications Physics. \\
                    & \pubnum{7} Jiao, Y.$^\#$, \textbf{Hang, H.}$^\#$,  Merel, J., \& Kanso, E.$^*$ (2025). \href{https://doi.org/10.1038/s41467-025-58125-6}{\textit{Sensing flow gradients is necessary for learning autonomous underwater navigation}}. Nature Communications, 16(1), 3044.
                    \\
    \hspace{-4ex}{2024}   & \pubnum{6} 
    ...
    & \pubnum{5} \textbf{Hang, H.},  Heydari, S. \& Kanso, E.$^*$   (2024). \href{http://dx.doi.org/10.23919/ACC60939.2024.10644662}{\textit{Feedback control of uncoordinated flapping swimmers to maintain school cohesion}}. American Control Conference (ACC)  \\
		  \hspace{-4ex}{2023}
		   & \pubnum{4} Qin, S., \textbf{Hang, H.}, Xiang, Y.$^*$ \& Liu, H. (2023). \href{https://doi.org/10.1016/j.cja.2023.09.030}{\textit{Reynolds-number scaling analysis on lift generation of a flapping and passive rotating wing with an inhomogeneous mass distribution}}. Chinese Journal of Aeronautics, 37(2), 259-269 \\
			\hspace{-4ex}{2022} 
			& \pubnum{3} \textbf{Hang, H.}, Heydari, S., Costello, J., \& Kanso, E.$^*$ (2022). \href{https://doi.org/doi:10.1017/jfm.2021.984}{\textit{Active tail flexion in concert with passive hydrodynamic forces improves swimming speed and efficiency}}. Journal of Fluid Mechanics, 932, A35.  \\
			\hspace{-4ex}{2021} 
			& \pubnum{2} Xiang, Y., \textbf{Hang, H.}, Qin, S.$^*$, \& Liu, H. (2021). \href{https://doi.org/10.1007/s10409-021-01134-7}{\textit{Scaling analysis of the circulation growth of leading-edge vortex in flapping flight}}. Acta Mech. Sin, 37(10), 1530-1543.  \\
			\hspace{-4ex}{2020} & \pubnum{1} \textbf{Hang, H.}, Yu, B., Xiang, Y., Zhang, B.$^*$, \& Liu, H. (2020).  \href{https://doi.org/10.1007/s12650-019-00605-1}{\textit{An objective-adaptive refinement criterion based on modified ridge extraction method for finite-time Lyapunov exponent (FTLE) calculation}}. Journal of Visualization, 23(1), 81-95. \\
       ...
       \section{Talks/Presentations}
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
                \hspace{-4ex}{2026}    & {\bf Gordon Research Seminar (GRS) Robotics: Bridging Scales in Robotics for Autonomous Embodied Systems}, Self-Reorganization and Information Transfer in Fish Schools at Extreme Scale \\
                \hspace{-4ex}{2025}    & {\bf APS Division of Fluid Dynamics Meeting}, Stability and Breakdown of Collective Milling in Large Fish Schools\\
                & {\bf IROS Nature-Inspired Intelligent Flight (NIIF) workshop}, Discovering autonomous navigation strategies in unsteady flows using reinforcement learning \\   & {\bf APS March Meeting}, Fish schooling at extreme scales  \\
    ...
    & {\bf So Cal Fluids XVI}, Active tail flexion in concert with passive hydrodynamic forces improves swimming speed and efficiency \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
         ...
         & Scale agent-based simulation to the order of $10^4$  and analyze the data based on continuum description  \\
			...
			& Develop efficient parallelized code using  fast multipole method (FMM) to simulate emergent formation of hydordynamically-coupled swimmers \\
			& Evaluate the energetic benefit and stability of fish schools of different spatial patterns \\
			...
			& Analyze the wake-tracking policy in a simplified signal field and prove that stability of the controller depends on the location of sensor \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
			...
			& Study formation of leading edge vortex(LEV) for different kinematic modes, and find that advanced rotation can generate a larger LEV because of wake capture \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
%             & \textbf{We media} \\
% \hspace{-4ex}{2025-} & Foundation of Network Science \href{https://space.bilibili.com/194511824/lists/5710937}{\faIcon{bilibili} BiliBili Link}  \href{https://github.com/haotianh9/graph_teaching }{\textit{\faGithub} Github Link}    \\
		...
		\sepline
         \begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
                \hspace{-4ex}{2025- } & Software defined radio \href{https://github.com/haotianh9/rtl-sdr-using-gnuradio}{\textit{\faGithub} Github Link}  \\
...
\section{Student Mentees}
    ...
    & \textbf{at University of Southern California} \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
                ...
                \hspace{-4ex}{2025} 
                 & Reviewer,  ICLR-AI4Mat 2025, Physics of Fluids, ICMI 2025, NeurIPS-AI4Mat 2025, Physical Review Fluids, RoboSoft 2026, Journal of Fluid Mechanics \\
                \hspace{-4ex}{2024} 
	...
	\hspace{-4ex}{2025}  & The William F. Ballhaus Jr. Prize for Excellence in Graduate Engineering Research (USC Viterbi School of Engineering’s Best Dissertation Award)  \href{https://viterbischool.usc.edu/news/2025/05/building-a-better-world-dean-yannis-c-yortsos-tells-graduates-they-will-make-a-difference/}{Link}  \\
