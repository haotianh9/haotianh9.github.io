...
\begin{document}
	...
	\begin{resume}%
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
			\hspace{-4ex}{2022} & {\bf So Cal Fluids XV}, Learning to blindly follow hydrodynamic trails \\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
			\hspace{-4ex}{2016 - 2019} & {\bf Mechanisms of high lift generation in insects flight}, supervised by \textit{Prof.~Hong Liu} \textit{Dr.~Yang Xiang} and \textit{Dr.~Suyang Qing}\\
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
			& \textbf{at University of Southern California} \\
			\hspace{-4ex}{2022} & EE-587, Nonlinear Control Systems\\
			& CSCI-561, Foundations of Artificial Intelligence\\
			& CSCI-567, Machine Learning\\
			& CSCI-653, High Performance Computing and Simulations\\
			\hspace{-4ex}{2021} & PHYS-516, Methods of Computational Physics\\
			...
			\hspace{-4ex}{2020} & AME-525, Engineering Analysis\\
			& AME-526, Introduction to Mathematical Methods in Engineering II,\\
			& AME-511, Compressible Gas Dynamics\\
			& PHYS-760, Selected Topics in Computational Physics\\
