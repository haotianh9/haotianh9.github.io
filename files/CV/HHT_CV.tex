...
\begin{document}
	...
	\begin{resume}%
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
				p{\dimexpr0.95\linewidth-2\tabcolsep-\arrayrulewidth\relax}@{}}
    \hspace{-4ex}{2024}
    & \nhphantom{8. }8. \textbf{Hang, H.},  Heydari, S. \& Kanso, E.     Feedback control of uncoordinated flapping swimmers to maintain school cohesion.  American Control Conference (ACC) 2024 \\
      & \nhphantom{7. }7. Jiao, Y., \textbf{Hang, H.},  Merel, J., \& Kanso, E. (in preparation). Evaluating egocentric and geocentric sensing for efficient underwater navigation using deep reinforcement learning  \\
		  \hspace{-4ex}{2023}
		   & \nhphantom{6. }6. \textbf{Hang, H.}, Jiao, Y., Heydari, S.,   Ling, F., Merel, J. \& Kanso, E. (submitted). \href{https://www.biorxiv.org/content/10.1101/2023.12.15.571932v1}{\textit{Interpretable and Generalizable Strategies for Stably Following Hydrodynamic Trails}}  \\
		   ...
		   & \nhphantom{4. }4. Qin, S., \textbf{Hang, H.}, Xiang, Y. \& Liu, H. (2023).\href{https://doi.org/10.1016/j.cja.2023.09.030}{\textit{Reynolds-number scaling analysis on lift generation of a flapping and passive rotating wing with an inhomogeneous mass distribution}}.  Chinese Journal of Aeronautics   \\
			...
			\hspace{-4ex}{2021} 
			& \nhphantom{2. }2. Xiang, Y., \textbf{Hang, H.}, Qin, S., and Liu, H. (2021). \href{https://doi.org/10.1007/s10409-021-01134-7}{\textit{Scaling analysis of the circulation growth of leading-edge vortex in flapping flight}}. Acta Mech. Sin, 37(10), 1530-1543.  \\
  ...
  \newpage
		...
		\begin{longtable}{@{}>{\raggedright}p{0.07\linewidth}
			...
			\hspace{-4ex}{2021 - } & {\bf Stability and energy saving of  fish schools}, supervised by \textit{Prof.~Eva Kanso}, \textit{Prof.~Matt McHenry} \\
            ...
            & Study the dynamically-changing real fish schools using graph theory\\
    ...
    \hspace{-4ex}{Fall 2022} & AME 441 project mentor, Robotic fish with artificial lateral line \\
